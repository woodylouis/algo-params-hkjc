...
public class TgsupCompareRepository {
    ...
    public TgsupCompareResponseDto executeStoredProcedure(Long eventId,
        ...
        List<TgsupCompareResultDto> results = (List<TgsupCompareResultDto>) resultMap.get("#result-set-1");


        if (results == null) results = List.of();


        return new TgsupCompareResponseDto(results, "");
    }
}